...
export function validateSiteContent(content) {
  ...
  assertAbsoluteUrl(content.site.docsUrl, "site.docsUrl");
  assertAbsoluteUrl(content.site.pricingUrl, "site.pricingUrl");
  assertAbsoluteUrl(content.site.contactUrl, "site.contactUrl");
